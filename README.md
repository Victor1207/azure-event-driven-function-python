...
**Issue:**  
Role assignments and identities did not appear immediately.
**Solution:**  
...
**Issue:**  
Code-less Application Insights was not supported due to subscription/runtime constraints.
...
**Issue:**  
Queue-triggered function did not show expected behavior initially.
